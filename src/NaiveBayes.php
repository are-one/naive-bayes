...
class NaiveBayes
{
    ...
    public function __construct($statements)
    {
       if(!is_array($statements)){
            throw new Exception("argumen data harus berupa array [statement, class]");
       }
    ...
    {    
        ...
        foreach ($this->classOfStatements as  $value) {
            # code...
            ${"prob_words_text_".$value} = $this->probWordsText($text, ${"count_feature_".$value}, ${"total_count_feature_".$value}, $total_unique_all_feature);
